...
- **If you discover bugs** while refactoring, raise them with `lazy_raise` and `blocking: false` (and call them out crisply in your final summary). Do not fix bugs in a refactoring task — that mixes concerns and makes review harder.
