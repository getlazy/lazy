...
6. **If you discover structural issues** in the code while reading it, raise them with `lazy_raise` and `blocking: false` (and call them out crisply in your final summary) but do NOT fix them yourself. This task is read-only for code.
