...
export const DOCS_PAGES = {
  ...
  'accept-check': { path: 'accept-check', source: 'accept-check.md' },
  'lazy-toml': { path: 'lazy-toml', source: 'lazy-toml.md' },
  'managed-config': { path: 'managed-config', source: 'managed-config.md' },
  'search': { path: 'search', source: 'search.md' },
  'identity': { path: 'identity', source: 'identity.md' },
  'memory': { path: 'memory', source: 'memory.md' },
  'artifacts': { path: 'artifacts', source: 'artifacts.md' },
  'raised-items': { path: 'raised-items', source: 'raised-items.md' },
  'turn-reports': { path: 'turn-reports', source: 'turn-reports.md' },
  'system-messages': { path: 'system-messages', source: 'system-messages.md' },
  'conversation-import': { path: 'conversation-import', source: 'conversation-import.md' },
  'link': { path: 'link', source: 'link.md' },
  'cluster-tasks': { path: 'cluster-tasks', source: 'cluster-tasks.md' },
  'review-paradigm': { path: 'review-paradigm', source: 'review-paradigm.md' },
  'review-line': {
    path: 'review-paradigm#reading-the-review-line',
    source: 'review-paradigm.md',
  },
  'agent-container': { path: 'agent-container', source: 'agent-container.md' },
  'self-hosting-task-turns': {
    path: 'self-hosting-lazy-teams#task-turns',
    source: 'self-hosting-lazy-teams.md',
  },
